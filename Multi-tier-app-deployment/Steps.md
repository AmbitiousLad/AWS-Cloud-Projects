...
![Screenshot 2024-12-13 171121](https://github.com/user-attachments/assets/ed58107b-f7c2-4abe-9302-cfcc565232ac)
...
If You dont have any domain , you can use the load balancer dns link to activate and for that , you should use the nginx-without-ssl.conf file provided in this repo
 to use load balancer dns link

First Copy all the text inside nginx-without-ssl.conf and paste it to nginx.conf and upload to s3 bucket
